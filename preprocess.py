...
def main_train():
    data_filename = "insurance-train.csv"
    out_filename = "insurance-preprocessed-train.csv"
    pipeline_filename = "insurance-preprocessor.joblib"
    label = "Premium Amount"
    preprocess_file(data_filename, out_filename, pipeline_filename, label)
    return

def main_test():
    data_filename = "insurance-test.csv"
    out_filename = "insurance-preprocessed-test.csv"
    pipeline_filename = "insurance-preprocessor.joblib"
    label = "Premium Amount"
    preprocess_file(data_filename, out_filename, pipeline_filename, label)
    return
